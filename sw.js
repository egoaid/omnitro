...
const CACHE_NAME = 'omnitro-cache-v12-1.5';
...
const APP_SHELL = [
  ...
  './css/variables.css?v12',
  './css/layout.css?v12',
  './css/chord-strum.css?v12',
  './css/overlays.css?v12',

  './js/state.js?v12',
  './js/music-theory.js?v12',
  './js/audio-core.js?v12',
  './js/native-strum-synth.js?v12',
  './js/voice-defs.js?v12',
  './js/rhythm-patterns.js?v12',
  './js/drum-synth-lm1.js?v12',
  './js/drum-kits.js?v12',
  './js/rhythm-scheduler.js?v12',
  './js/chord-playback.js?v12',
  './js/strumplate-core.js?v12',
  './js/chord-ui.js?v12',
  './js/strumplate-ui.js?v12',
  './js/settings-ui.js?v12',
  './js/rhythm-ui.js?v12',
  './js/rhythm-editor.js?v12',
  './js/piano-roll.js?v12',
  './js/recording.js?v12',
  './js/mix-studio.js?v12',
  './js/kit-editor.js?v12',
  './js/midi.js?v12',
  './js/manual-content.js?v12',
  './js/manual-ui.js?v12',
  './js/arrangement.js?v12',
  './js/main.js?v12',
